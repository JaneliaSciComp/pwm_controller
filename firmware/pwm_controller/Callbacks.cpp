...
void setServoPositionCallback()
{
  long channel = modular_server.getParameterValue(constants::channel_parameter_name);
  long servo_position = modular_server.getParameterValue(constants::servo_position_parameter_name);
  controller.setServoPosition(channel,servo_position);
}
