...
{
  pwm_driver_.begin();
  pwm_driver_.setPWMFreq(constants::servo_pwm_frequency);
  ...
  ModularDevice::Parameter& servo_position_parameter = modular_server_.createParameter(constants::servo_position_parameter_name);
  servo_position_parameter.setRange(constants::servo_position_min,constants::servo_position_max);
  servo_position_parameter.setUnits(constants::servo_position_units_name);
  ...
  // Methods
  ModularDevice::Method& set_servo_position_method = modular_server_.createMethod(constants::set_servo_position_method_name);
  set_servo_position_method.attachCallback(callbacks::setServoPositionCallback);
  set_servo_position_method.addParameter(channel_parameter);
  set_servo_position_method.addParameter(servo_position_parameter);
...
void Controller::setServoPosition(size_t channel, size_t servo_position)
{
  uint16_t duty_cycle = map(servo_position,
                            constants::servo_position_min,
                            constants::servo_position_max,
                            constants::servo_duty_cycle_min,
                            constants::servo_duty_cycle_max);
  pwm_driver_.setPWM(channel,0,duty_cycle);
}
